...
export const STUDENTS: Student[] = [
  ...
  },
  {
    ...
    fullName: "Marcus Alexis Vazquez Zavala",
    gradeGroup: "4TO Programacion",
    career: "PROGRAMACIÓN",
    semesterGroup: "4TO | DPGM",
    shift: "VESPERTINO",
    credentialValidUntil: "31 DE JULIO / 2026-1",
    credentialQrPayload:
      "https://www.cecytebc.edu.mx/lincesapp/prod/controlesc/credential/265147/05669",
    photoUrl:
      "https://ui-avatars.com/api/?name=Marcus+Alexis&background=0A2A66&color=fff&size=256",
    guardianEmail: "tutor.marcus@example.com",
    allowedExitTimes: ["14:00", "19:00"],
    absences: 0,
  },
  {
    id: "st-05",
    enrollment: "24402080059901",
    fullName: "Prueba Grupo CPGM",
    gradeGroup: "4TO Programacion",
    semesterGroup: "4TO | CPGM",
    career: "PROGRAMACIÓN",
    shift: "VESPERTINO",
    photoUrl: "https://ui-avatars.com/api/?name=CPGM&background=0A2A66&color=fff&size=256",
    guardianEmail: "tutor.cpgm@example.com",
    allowedExitTimes: ["14:00"],
    absences: 1,
  },
];
